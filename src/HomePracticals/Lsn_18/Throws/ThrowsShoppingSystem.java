...
public class ThrowsShoppingSystem {
    ...
    public void purchaseItem(String item, int quantityRequest) throws InsufficientStockExceptionCh, ItemNotFoundExceptionCh,
            IllegalArgumentException, NullPointerException {

        // Checking if any of the array data.txt is not available - null
        ...
        if (isProductAvailable(item)){
            ...
            if (isSufficientStock(item, quantityRequest)){
                ...
                throw new InsufficientStockExceptionCh("Unfortunately, the requested quantity (" + quantityRequest + ") is not available in the stock for \"" + item + "\".\n");
            }
        }else {
            throw new ItemNotFoundExceptionCh("Unfortunately, \"" + item + "\" not found in our stock list.\n");
        }
    }
